...
Spurious interrupt may be generated by a careless write. Risc-V Priviledged ISA Specification suggests the following
code in order to update `mtimecmp`. Another option is to keep `MTIE` equal 0 (interrupt disabled) while updating
`mtimecmp`.
